 ...
 * @author Ralph kar
 */
class HokageSplitPaneDivider extends BasicSplitPaneDivider
{
    private HokageBumps bumps = new HokageBumps(10, 10,
                 HokageLookAndFeel.getControlHighlight(),
                 HokageLookAndFeel.getControlDarkShadow(),
                 HokageLookAndFeel.getControl() );

    private HokageBumps focusBumps = new HokageBumps(10, 10,
    ...
    private Color controlColor = HokageLookAndFeel.getControl();
    private Color primaryControlColor = UIManager.getColor(
                                "SplitPane.dividerFocusColor");

    public HokageSplitPaneDivider(BasicSplitPaneUI ui) {
        super(ui);
    }

    public void paint(Graphics g) {
	HokageBumps usedBumps;
