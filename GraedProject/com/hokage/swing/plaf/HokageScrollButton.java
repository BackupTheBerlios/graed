 ...
 * @author Steve Wilson
 */
public class HokageScrollButton extends BasicArrowButton
{
  ...
  private int buttonWidth;
        ...
        public HokageScrollButton( int direction, int width, boolean freeStanding )
        {
            super( direction );
	...
	public void paint( Graphics g )
        {
            boolean leftToRight = HokageUtils.isLeftToRight(this);
	    boolean isEnabled = getParent().isEnabled();

	    Color arrowColor = isEnabled ? HokageLookAndFeel.getControlInfo() : HokageLookAndFeel.getControlDisabled();
	...
	/*	g.drawLine( 7, 6, 8, 6 );
		...
		if (isEnabled) {
		    ...
		    HokageUtils.drawDisabledBorder(g, 0, 0, width, height+1);
		}
	        if ( !isFreeStanding ) {
                    height -= 1;
                    g.translate( 0, 1 );
	...
	/*	g.drawLine( 4, 5, 11, 5 );
		...
		if (isEnabled) {
		    ...
		    HokageUtils.drawDisabledBorder(g, 0,-1, width, height+1);
		}
...
/*		g.drawLine( 5, 4, 5, 11 );
		...
		if (isEnabled) {
		    ...
		    HokageUtils.drawDisabledBorder(g,-1,0, width+1, height);
		}
	        if ( !isFreeStanding ) {
		    height -= 2;
		    width -= 1;
	...
	/*	g.drawLine( 6, 7, 6, 8 );
		...
		if (isEnabled) {
		    ...
		    HokageUtils.drawDisabledBorder(g,0,0, width+1, height);
		}
