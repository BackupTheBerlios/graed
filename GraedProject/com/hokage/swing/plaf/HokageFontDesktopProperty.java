 ...
 */
class HokageFontDesktopProperty extends com.sun.java.swing.plaf.windows.DesktopProperty {
    /**
     ...
     */
    HokageFontDesktopProperty(int type) {
     ...
     *        type.
     */
    HokageFontDesktopProperty(String key, Toolkit kit, int type) {
        super(key, null, kit);
        this.type = type;
    }
    ...
    protected Object configureValue(Object value) {
        if (value instanceof Integer) {
            value = new Font(DefaultHokageTheme.getDefaultFontName(type),
                             DefaultHokageTheme.getDefaultFontStyle(type),
    ...
    protected Object getDefaultValue() {
        return new Font(DefaultHokageTheme.getDefaultFontName(type),
                        DefaultHokageTheme.getDefaultFontStyle(type),
                        DefaultHokageTheme.getDefaultFontSize(type));
    }
}
