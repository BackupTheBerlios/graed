 ...
 * @author Steve Wilson
 */
public class HokageToolTipUI extends BasicToolTipUI {

    static HokageToolTipUI sharedInstance = new HokageToolTipUI();
	...
	if (comp instanceof JTabbedPane) {
	  ...
	  if (ui instanceof HokageTabbedPaneUI) {		
	    // if comp is instance of JTabbedPane and have 'metal' look-and-feel
	    // detect tab the mouse is over now
	    int rolloverTabIndex = ( (HokageTabbedPaneUI)ui ).getRolloverTabIndex();
