 ...
 *
 * @see HokageComboBoxButton
 * @version 1.38 12/19/03
 * @author Tom Santos
 */
public class HokageComboBoxButton extends JButton {
    ...
    public HokageComboBoxButton( JComboBox cb, Icon i, 
    ...
    public HokageComboBoxButton( JComboBox cb, Icon i, boolean onlyIcon,
                                CellRendererPane pane, JList list ) {
        this( cb, i, pane, list );
        iconOnly = onlyIcon;
    }
    ...
    public void paintComponent( Graphics g ) {
        boolean leftToRight = HokageUtils.isLeftToRight(comboBox);
        ...
        if ( comboIcon != null ) {
            ...
            // Paint the focus
            if ( comboBox.hasFocus() && (!HokageLookAndFeel.usingOcean() ||
                                         comboBox.isEditable())) {
                g.setColor( HokageLookAndFeel.getFocusColor() );
