 ...
 * @author Steve Wilson
 */
public class HokagelInternalFrameUI extends BasicInternalFrameUI {

  private HokageInternalFrameTitlePane titlePane;
  ...
  public HokagelInternalFrameUI(JInternalFrame b)   {
    super(b);
  }

  public static ComponentUI createUI(JComponent c)    {
      return new HokagelInternalFrameUI( (JInternalFrame) c);
  }
  ...
  protected JComponent createNorthPane(JInternalFrame w) {
    titlePane = new HokageInternalFrameTitlePane(w);
    return titlePane;
  }
        ...
        PropertyChangeListener
  {
	  ...
	  String name = e.getPropertyName();
          ...
          if (!(jif.getUI() instanceof HokagelInternalFrameUI)) {
              return;
          }

          HokagelInternalFrameUI ui = (HokagelInternalFrameUI)jif.getUI();
