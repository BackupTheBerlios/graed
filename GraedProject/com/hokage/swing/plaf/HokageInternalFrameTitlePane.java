...
public class HokageInternalFrameTitlePane  extends BasicInternalFrameTitlePane {
    ...
    HokageBumps activeBumps 
        = new HokageBumps( 0, 0,
                          HokageLookAndFeel.getPrimaryControlHighlight(),
    ...
    HokageBumps paletteBumps;

    private Color activeBumpsHighlight = HokageLookAndFeel.
                             getPrimaryControlHighlight();
    private Color activeBumpsShadow = HokageLookAndFeel.
                             getPrimaryControlDarkShadow();
					    
    public HokageInternalFrameTitlePane(JInternalFrame f) {
        super( f );
    }
    ...
    protected void createButtons() {
        ...
        closeButton.setBackground(HokageLookAndFeel.getPrimaryControlShadow());
    ...
    class MetalTitlePaneLayout extends TitlePaneLayout {    
        ...
        public void layoutContainer(Container c) {
            boolean leftToRight = HokageUtils.isLeftToRight(frame);
    ...
    public void paintPalette(Graphics g)  {
        ...
        if (paletteBumps == null) {
            paletteBumps 
                = new HokageBumps(0, 0,
                                 HokageLookAndFeel.getPrimaryControlHighlight(),
                                 HokageLookAndFeel.getPrimaryControlInfo(),
                                 HokageLookAndFeel.getPrimaryControlShadow() );
        }

        Color background = HokageLookAndFeel.getPrimaryControlShadow();     
        Color darkShadow = HokageLookAndFeel.getPrimaryControlDarkShadow();
    ...
    public void paintComponent(Graphics g)  {
        ...
        if (isSelected) {
            ...
            if (background == null) {
                background = HokageLookAndFeel.getWindowTitleBackground();
            }
            ...
            if (shadow == null) {
                shadow = HokageLookAndFeel.getPrimaryControlDarkShadow();
            }
            if (foreground == null) {
                foreground = HokageLookAndFeel.getWindowTitleForeground();
            }
            ...
            background = HokageLookAndFeel.getWindowTitleInactiveBackground();
            foreground = HokageLookAndFeel.getWindowTitleInactiveForeground();
            shadow = HokageLookAndFeel.getControlDarkShadow();
            bumps = inactiveBumps;
            gradientKey = "InternalFrame.inactiveTitleGradient";
        }

        if (!HokageUtils.drawGradient(this, g, gradientKey, 0, 0, width,
                                     height, true)) {
            g.setColor(background);
            g.fillRect(0, 0, width, height);
        }
