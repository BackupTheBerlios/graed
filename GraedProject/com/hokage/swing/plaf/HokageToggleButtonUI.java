 ...
 * @author Tom Santos
 */
public class HokageToggleButtonUI extends BasicToggleButtonUI {

    private static final HokageToggleButtonUI metalToggleButtonUI = new HokageToggleButtonUI();
            ...
            if (!HokageUtils.isToolBarButton(c)) {
                if (!model.isArmed() && !model.isPressed() &&
                    ...
                    return;
                        ...
                        HokageUtils.drawGradient(c, g, "ToggleButton.gradient",
