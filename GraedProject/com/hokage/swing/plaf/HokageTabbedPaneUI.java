...
public class HokageTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    private Color hokageFocus;

    public static ComponentUI createUI( JComponent x ) {
        return new HokageTabbedPaneUI();
    }  
    ...
    protected void installDefaults() {
        ...
        ocean = HokageLookAndFeel.usingOcean();
        hokageFocus = UIManager.getColor("Button.focus");
        if (ocean) {
	...
	boolean leftToRight = HokageUtils.isLeftToRight(tabPane);
    ...
    protected boolean shouldFillGap( int currentRun, int tabIndex, int x, int y ) {
	    ...
	    Rectangle tabBounds = getTabBounds( tabPane, tabIndex );
            if (HokageUtils.isLeftToRight(tabPane)) {
