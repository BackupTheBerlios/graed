...
/**
 * Implements the Java look and feel (codename: Hokage).
 * <p>
 * By default Hokage uses bold fonts for many controls.  To make all
 ...
 * the following:
 * <ul>
 * <li>Set the system property <code>swing.boldHokage</code> to
 *     <code>false</code>.  For example,
 *     <code>java&nbsp;-Dswing.boldHokage=false&nbsp;MyApp</code>.
 * <li>Set the defaults property <code>swing.boldHokage</code> to
 *     <code>Boolean.FALSE</code>.  For example:
 *     <code>UIManager.put("swing.boldHokage",&nbsp;Boolean.FALSE);</code>
 * </ul>
 * The defaults property <code>swing.boldHokage</code>, if set,
 ...
 * <code>HokageLookAndFeel</code>, as well as update the UI
 * of any previously created widgets. Otherwise the results are undefined.
 * These lines of code show you how to accomplish this:
 * <pre>
 *   // turn off bold fonts
 *   UIManager.put("swing.boldHokage", Boolean.FALSE);
 *
 *   // re-install the Hokage Look and Feel
 *   UIManager.setLookAndFeel(new HokageLookAndFeel());
 *
 ...
 *
 * @version @(#)HokageLookAndFeel.java	1.182 04/04/02
 * @author Steve Wilson
 */
public class HokageLookAndFeel extends BasicLookAndFeel
{

    private static boolean Hokage_LOOK_AND_FEEL_INITED = false;

    private static HokageTheme currentTheme;
    ...
    static boolean useSystemFonts() {
        if (isWindows() && useSystemFonts) {
            if (Hokage_LOOK_AND_FEEL_INITED) {
                Object value = UIManager.get(
                                 "Application.useSystemFontSettings");

                return (value == null || Boolean.TRUE.equals(value));
            }
            // If an instanceof HokageLookAndFeel hasn't been inited yet, we
    ...
    public String getDescription() {
        return "The Hokage Look and Feel";
    }
     ...
     * which this method maps to "com.hokage.swing.plaf.HokageButtonUI".
     * 
    ...
    protected void initClassDefaults(UIDefaults table)
    {
        ...
        final String HokagePackageName = "com.hokage.swing.plaf.";

        Object[] uiDefaults = {
                   "ButtonUI", HokagePackageName + "HokageButtonUI",
                 "CheckBoxUI", HokagePackageName + "HokageCheckBoxUI",
                 "ComboBoxUI", HokagePackageName + "HokageComboBoxUI",
              "DesktopIconUI", HokagePackageName + "HokageDesktopIconUI",
              "FileChooserUI", HokagePackageName + "HokageFileChooserUI",
            "InternalFrameUI", HokagePackageName + "HokageInternalFrameUI",
                    "LabelUI", HokagePackageName + "HokageLabelUI",
       "PopupMenuSeparatorUI", HokagePackageName + "HokagePopupMenuSeparatorUI",
              "ProgressBarUI", HokagePackageName + "HokageProgressBarUI",
              "RadioButtonUI", HokagePackageName + "HokageRadioButtonUI",
                "ScrollBarUI", HokagePackageName + "HokageScrollBarUI",
               "ScrollPaneUI", HokagePackageName + "HokageScrollPaneUI",
                "SeparatorUI", HokagePackageName + "HokageSeparatorUI",
                   "SliderUI", HokagePackageName + "HokageSliderUI",
                "SplitPaneUI", HokagePackageName + "HokageSplitPaneUI",
               "TabbedPaneUI", HokagePackageName + "HokageTabbedPaneUI",
                "TextFieldUI", HokagePackageName + "HokageTextFieldUI",
             "ToggleButtonUI", HokagePackageName + "HokageToggleButtonUI",
                  "ToolBarUI", HokagePackageName + "HokageToolBarUI",
                  "ToolTipUI", HokagePackageName + "HokageToolTipUI",
                     "TreeUI", HokagePackageName + "HokageTreeUI",
                 "RootPaneUI", HokagePackageName + "HokageRootPaneUI",
        };
    ...
    {
        HokageTheme theme = getCurrentTheme();
  ...
  "inactiveCaptionBorder", theme.getControlShadow(), /* Border color for inactive caption (title bar) window borders. */
    ...
    private void initResourceBundle(UIDefaults table) {
        table.addResourceBundle( "com.sun.swing.internal.plaf.Hokage.resources.Hokage" );
    }
    ...
    protected void initComponentDefaults(UIDefaults table) {
        ...
        Color buttonFocusColor = new ColorUIResource(0x00AAAA);
	...
	Object textFieldBorder = 
	    new HokageLazyValue("com.hokage.swing.plaf.HokageBorders",
					  "getTextFieldBorder");

        Object dialogBorder = new HokageLazyValue(
                          "com.hokage.swing.plaf.HokageBorders$DialogBorder");

        Object questionDialogBorder = new HokageLazyValue(
                  "com.hokage.swing.plaf.HokageBorders$QuestionDialogBorder");
	...
	Object multilineInputMap = new UIDefaults.LazyInputMap(new Object[] {
        ...
        Object scrollPaneBorder = new HokageLazyValue("com.hokage.swing.plaf.HokageBorders$ScrollPaneBorder");
        Object buttonBorder = 
	    	    new HokageLazyValue("com.hokage.swing.plaf.HokageBorders",
					  "getButtonBorder");
	    ...
	    new HokageLazyValue(
			  "com.hokage.swing.plaf.HokageBorders",
			  "getDesktopIconBorder");

        Object menuBarBorder = 
	    new HokageLazyValue(
			  "com.hokage.swing.plaf.HokageBorders$MenuBarBorder");

        Object popupMenuBorder = 
	    new HokageLazyValue(
			 "com.hokage.swing.plaf.HokageBorders$PopupMenuBorder");
        Object menuItemBorder = 
	    new HokageLazyValue(
			 "com.hokage.swing.plaf.HokageBorders$MenuItemBorder");

	Object menuItemAcceleratorDelimiter = new String("-");
        Object toolBarBorder = new HokageLazyValue("com.hokage.swing.plaf.HokageBorders$ToolBarBorder");
	...
	Object[] defaultCueList = new Object[] {
	    ...
	    "EditorPane.focusInputMap", multilineInputMap,
		 ...
		 "ctrl shift RIGHT", DefaultEditorKit.selectionNextWordAction,
		  ...
		  "ctrl BACK_SLASH", "unselect",
            ...
            "CheckBox.icon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getCheckBoxIcon"),
	    "CheckBox.focusInputMap",
	       new UIDefaults.LazyInputMap(new Object[] {
            ...
            "RadioButton.icon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getRadioButtonIcon"),
	    ...
	    "ToggleButton.focusInputMap",
	      new UIDefaults.LazyInputMap(new Object[] {
            ...
            // File View 
            "FileView.directoryIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getTreeFolderIcon"),
            "FileView.fileIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getTreeLeafIcon"),
            "FileView.computerIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getTreeComputerIcon"),
            "FileView.hardDriveIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getTreeHardDriveIcon"),
            "FileView.floppyDriveIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getTreeFloppyDriveIcon"),

            // File Chooser
            "FileChooser.detailsViewIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getFileChooserDetailViewIcon"),
            "FileChooser.homeFolderIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getFileChooserHomeFolderIcon"),
            "FileChooser.listViewIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getFileChooserListViewIcon"),
            "FileChooser.newFolderIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getFileChooserNewFolderIcon"),
            "FileChooser.upFolderIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getFileChooserUpFolderIcon"),
	    ...
	    "Slider.focusInsets", zeroInsets,
            ...
            "Slider.horizontalThumbIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getHorizontalSliderThumbIcon"),
            "Slider.verticalThumbIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getVerticalSliderThumbIcon"),
		...
		"alt KP_DOWN", "togglePopup",
		  ...
		  "alt KP_UP", "togglePopup",
            ...
            "InternalFrame.icon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getInternalFrameDefaultMenuIcon"),
            "InternalFrame.border", new HokageLazyValue("com.hokage.swing.plaf.HokageBorders$InternalFrameBorder"),
            "InternalFrame.optionDialogBorder", new HokageLazyValue("com.hokage.swing.plaf.HokageBorders$OptionDialogBorder"),
            "InternalFrame.paletteBorder", new HokageLazyValue("com.hokage.swing.plaf.HokageBorders$PaletteBorder"),
	    "InternalFrame.paletteTitleHeight", new Integer(11),
	    "InternalFrame.paletteCloseIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory$PaletteCloseIcon"),
            "InternalFrame.closeIcon", 
                  new SwingLazyValue(
				     "com.hokage.swing.plaf.HokageIconFactory", 
       ...
       "shift ctrl alt F6", "selectPreviousFrame",
	    ...
	    "TableHeader.cellBorder", new HokageLazyValue(
					  "com.hokage.swing.plaf.HokageBorders$TableHeaderBorder"),
	    ...
	    "Menu.submenuPopupOffsetY", new Integer(-3),
            ...
            "Menu.checkIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getMenuItemCheckIcon"),
            "Menu.arrowIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getMenuArrowIcon"),
	    ...
	    "MenuItem.acceleratorDelimiter", menuItemAcceleratorDelimiter,
            "MenuItem.checkIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getMenuItemCheckIcon"),
            "MenuItem.arrowIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getMenuItemArrowIcon"),
	    ...
	    // Option Pane Auditory Cue Mappings
            ...
            // Option Pane Special Dialog Colors, used when HokageRootPaneUI
            ...
            "CheckBoxMenuItem.checkIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getCheckBoxMenuItemIcon"),
            "CheckBoxMenuItem.arrowIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getMenuItemArrowIcon"),
	    "CheckBoxMenuItem.commandSound", "sounds/MenuItemCommand.wav",
            ...
            "RadioButtonMenuItem.checkIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getRadioButtonMenuItemIcon"),
            "RadioButtonMenuItem.arrowIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getMenuItemArrowIcon"),
	    ...
	    "SplitPane.ancestorInputMap",
 	    ...
 	    "ctrl shift TAB", "focusOutBackward"
            ...
            "Tree.openIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getTreeFolderIcon"),
            "Tree.closedIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getTreeFolderIcon"),
            "Tree.leafIcon", new HokageLazyValue("com.hokage.swing.plaf.HokageIconFactory", "getTreeLeafIcon"),
            "Tree.expandedIcon", new SwingLazyValue(
				     "com.hokage.swing.plaf.HokageIconFactory", 
				     "getTreeControlIcon",
				     new Object[] {Boolean.valueOf(HokageIconFactory.DARK)}),
            "Tree.collapsedIcon", new SwingLazyValue(
				     "com.hokage.swing.plaf.HokageIconFactory", 
				     "getTreeControlIcon",
				     new Object[] {Boolean.valueOf( HokageIconFactory.LIGHT )}),
	    ...
	    "Tree.ancestorInputMap",
	       new UIDefaults.LazyInputMap(new Object[] {
            ...
            "ToolBar.rolloverBorder", new HokageLazyValue(
                         "com.hokage.swing.plaf.HokageBorders",
                         "getToolBarRolloverBorder"),
            "ToolBar.nonrolloverBorder", new HokageLazyValue(
                         "com.hokage.swing.plaf.HokageBorders",
	    ...
	    "ToolBar.ancestorInputMap",
		  ...
		  "KP_RIGHT", "navigateRight"
            ...
            // RootPane
            "RootPane.frameBorder", new HokageLazyValue(
                      "com.hokage.swing.plaf.HokageBorders$FrameBorder"),
            "RootPane.plainDialogBorder", dialogBorder,
            "RootPane.informationDialogBorder", dialogBorder,
            "RootPane.errorDialogBorder", new HokageLazyValue(
                      "com.hokage.swing.plaf.HokageBorders$ErrorDialogBorder"),
            ...
            "RootPane.warningDialogBorder", new HokageLazyValue(
                    "com.hokage.swing.plaf.HokageBorders$WarningDialogBorder"),
        ...
        if (isWindows() && useSystemFonts() && theme.isSystemTheme()) {
            ...
            Object messageFont = new HokageFontDesktopProperty(
                              "win.messagebox.font.height", kit, HokageTheme.
                              CONTROL_TEXT_FONT);
    ...
    public UIDefaults getDefaults() {
        ...
        Hokage_LOOK_AND_FEEL_INITED = true;
    ...
    /**
     * Set the theme to be used by <code>HokageLookAndFeel</code>.
     ...
     * <pre>
     *   // turn off bold fonts
     *   HokageLookAndFeel.setCurrentTheme(theme);
     *
     *   // re-install the Hokage Look and Feel
     *   UIManager.setLookAndFeel(new HokageLookAndFeel());
     *
     ...
     * @see #getCurrentTheme
     */
    public static void setCurrentTheme(HokageTheme theme) {
	...
	cachedAppContext.put( "currentHokageTheme", theme );
    }

    /**
     * Return the theme currently being used by <code>HokageLookAndFeel</code>.
     ...
     * @since 1.5
     */
    public static HokageTheme getCurrentTheme() {
        AppContext context = AppContext.getAppContext();

	if ( cachedAppContext != context ) {
	    currentTheme = (HokageTheme)context.get( "currentHokageTheme" );
            if (currentTheme == null) {
                // This will happen in two cases:
                // . When HokageLookAndFeel is first being initialized.
                ...
                if (useHighContrastTheme()) {
                    currentTheme = new HokageHighContrastTheme();
                }
                else {
    ...
    public Icon getDisabledIcon(JComponent component, Icon icon) {
        if ((icon instanceof ImageIcon) && HokageLookAndFeel.usingOcean()) {
            return HokageUtils.getOceanDisabledButtonIcon(
    ...
    /**
     * HokageLazyValue is a slimmed down version of <code>ProxyLaxyValue</code>.
     * The code is duplicate so that it can get at the package private
     * classes in Hokage.
     */
    private static class HokageLazyValue implements UIDefaults.LazyValue {
        /**
        ...
        HokageLazyValue(String name) {
            this.className = name;
        }

        HokageLazyValue(String name, String methodName) {
            this(name);
    ...
    /**
     * FontActiveValue redirects to the appropriate Hokage theme method.
     */
    private static class FontActiveValue implements UIDefaults.ActiveValue {
        private int type;
        private HokageTheme theme;

        FontActiveValue(HokageTheme theme, int type) {
            this.theme = theme;
            this.type = type;
        }
        ...
        public Object createValue(UIDefaults table) {
            Object value = null;
            switch (type) {
            case HokageTheme.CONTROL_TEXT_FONT:
                value = theme.getControlTextFont();
                break;
            case HokageTheme.SYSTEM_TEXT_FONT:
                value = theme.getSystemTextFont();
                break;
            case HokageTheme.USER_TEXT_FONT:
                value = theme.getUserTextFont();
                break;
            case HokageTheme.MENU_TEXT_FONT:
                value = theme.getMenuTextFont();
                break;
            case HokageTheme.WINDOW_TITLE_FONT:
                value = theme.getWindowTitleFont();
                break;
            case HokageTheme.SUB_TEXT_FONT:
