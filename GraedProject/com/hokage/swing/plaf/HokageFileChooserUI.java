 ...
 * @author Jeff Dinkins
 */
public class HokageFileChooserUI extends BasicFileChooserUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new HokageFileChooserUI((JFileChooser) c);
    }

    public HokageFileChooserUI(JFileChooser filechooser) {
	super(filechooser);
    }
	...
	public JFileChooser getFileChooser() {
	    return HokageFileChooserUI.this.getFileChooser();
	}

	public BasicDirectoryModel getModel() {
	    return HokageFileChooserUI.this.getModel();
	}

	public JPanel createList() {
	    return HokageFileChooserUI.this.createList(getFileChooser());
	}

	public JPanel createDetailsView() {
	    return HokageFileChooserUI.this.createDetailsView(getFileChooser());
	}

	public boolean isDirectorySelected() {
	    return HokageFileChooserUI.this.isDirectorySelected();
	}

	public File getDirectory() {
	    return HokageFileChooserUI.this.getDirectory();
	}

	public Action getChangeToParentDirectoryAction() {
	    return HokageFileChooserUI.this.getChangeToParentDirectoryAction();
	}

	public Action getApproveSelectionAction() {
	    return HokageFileChooserUI.this.getApproveSelectionAction();
	}

	public Action getNewFolderAction() {
	    return HokageFileChooserUI.this.getNewFolderAction();
	}

	public MouseListener createDoubleClickListener(JList list) {
	    return HokageFileChooserUI.this.createDoubleClickListener(getFileChooser(),
								     list);
	}

	public ListSelectionListener createListSelectionListener() {
	    return HokageFileChooserUI.this.createListSelectionListener(getFileChooser());
	}
    }
