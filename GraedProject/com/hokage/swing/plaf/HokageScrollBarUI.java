 ...
 * @author Steve Wilson
 */
public class HokageScrollBarUI extends BasicScrollBarUI
{
    ...
    protected HokageBumps bumps;

    protected HokageScrollButton increaseButton;
    protected HokageScrollButton decreaseButton;
    ...
    {
        return new HokageScrollBarUI();
    }

    protected void installDefaults() {
	scrollBarWidth = ((Integer)(UIManager.get( "ScrollBar.width" ))).intValue();
	super.installDefaults();
	bumps = new HokageBumps( 10, 10, thumbHighlightColor, thumbShadow, thumbColor );    
    }
    ...
    {
        decreaseButton = new HokageScrollButton( orientation, scrollBarWidth, isFreeStanding );
    ...
    {
        increaseButton =  new HokageScrollButton( orientation, scrollBarWidth, isFreeStanding );
    ...
    protected void paintTrack( Graphics g, JComponent c, Rectangle trackBounds )
    {
        ...
        boolean leftToRight = HokageUtils.isLeftToRight(c);
	...
	if ( scrollbar.getOrientation() == JScrollBar.VERTICAL )
	{
		...
		HokageUtils.drawDisabledBorder(g, 0, 0, trackBounds.width, trackBounds.height );
	    }
    ...
    private void oceanPaintThumb(Graphics g, JComponent c,
        ...
        if (scrollbar.getOrientation() == JScrollBar.VERTICAL) {
            ...
            HokageUtils.drawGradient(c, g, "ScrollBar.gradient", 2, 2,
                                    thumbBounds.width - 4,
