 ...
 * @since 1.4
 */
class HokageTitlePane extends JComponent {
     ...
     */
    private HokageRootPaneUI rootPaneUI;
    ...
    private Color activeBumpsHighlight = HokageLookAndFeel.getPrimaryControlHighlight();
    private Color activeBumpsShadow = HokageLookAndFeel.getPrimaryControlDarkShadow();
    private Color activeBackground = null;
    private Color activeForeground = null;
    private Color activeShadow = null;

    // Bumps
    private HokageBumps activeBumps 
        = new HokageBumps( 0, 0,
                          activeBumpsHighlight,
                          activeBumpsShadow,
                          HokageLookAndFeel.getPrimaryControl() );
    private HokageBumps inactiveBumps 
        = new HokageBumps( 0, 0,
    ...
    public HokageTitlePane(JRootPane root, HokageRootPaneUI ui) {
        this.rootPane = root;
        rootPaneUI = ui;
    ...
    private void addMenuItems(JMenu menu) {
        ...
        int mnemonic = HokageUtils.getInt("MetalTitlePane.restoreMnemonic", -1);
        ...
        mnemonic = HokageUtils.getInt("MetalTitlePane.iconifyMnemonic", -1);
        if (mnemonic != -1) {
            mi.setMnemonic(mnemonic);
        }
        ...
        if (Toolkit.getDefaultToolkit().isFrameStateSupported(
            ...
            mnemonic =
                HokageUtils.getInt("MetalTitlePane.maximizeMnemonic", -1);
            if (mnemonic != -1) {
                mi.setMnemonic(mnemonic);
            }
        }
        ...
        mnemonic = HokageUtils.getInt("MetalTitlePane.closeMnemonic", -1);
        if (mnemonic != -1) {
            mi.setMnemonic(mnemonic);
        }
    }
