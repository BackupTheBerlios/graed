 ...
 * @author Steve Wilson
 */
public class DefaultHokageTheme extends HokageTheme {
    /**
    ...
    void install() {
        if (HokageLookAndFeel.isWindows() &&
                             HokageLookAndFeel.useSystemFonts()) {
    ...
    boolean isSystemTheme() {
        return (getClass() == DefaultHokageTheme.class);
    }
    ...
    private static class WindowsFontDelegate extends FontDelegate {
        private HokageFontDesktopProperty[] props;
        private boolean[] checkedPriviledged;

        public WindowsFontDelegate() {
            props = new HokageFontDesktopProperty[6];
        ...
        public FontUIResource getFont(int type) {
            ...
            if (props[type] == null) {
                props[type] = new HokageFontDesktopProperty(type);
            }
